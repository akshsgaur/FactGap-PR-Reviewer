#!/usr/bin/env python3
"""Simple cleanup script using existing database connection"""
...
async def cleanup_user_data():
    ...
    try:
        # 1. Clear user-scoped embeddings
        print("🗑️  Clearing user-scoped embeddings...")
        
        # Use simple delete with filter
        delete_result = db.client.table('rag_chunks').delete().eq('user_id', '00000000-0000-0000-0000-000000001').execute()
